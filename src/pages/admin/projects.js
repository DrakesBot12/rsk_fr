...
const projects = [
    ...
    { id: 6, name: "Автоматизация проверки домашних заданий", case: "Автоматизация" },
    { id: 1, name: "Создание базы знаний для преподавателей", case: "Знания и навыки" },
    { id: 2, name: "Организация цифровых ярмарок вакансий", case: "Взаимодействие с работодателями" },
    ...
    { id: 6, name: "Автоматизация формирования расписания занятий", case: "Автоматизация" },
    ...
    { id: 6, name: "Автоматизация процесса подачи заявок на курсы", case: "Автоматизация" },
