            ...
            <div className='hero' style={{ placeItems: 'center' }}>
                <div className='flex flex-col gap-[1.6rem] items-center h-full col-span-4 col-start-5 col-end-9'>
                    ...
                    <div className='flex flex-col gap-[0.75rem]'>
                        <div className='flex flex-col gap-[0.5rem]'>
                            ...
                            <p className='small text-(--color-gray-black)'>
                                Это ваш токен доступа. Он имеет ограниченное количество
                                использований. На шкале под полем отображается, сколько запросов
                                уже израсходовано
                            </p>
                        </div>
                        <Input
                    ...
                    />
                        ...
                        {showNotification && tokenExists && (
                            <span className='big p-3 bg-green-100 text-green-700 rounded-md'>
                                Тренажер активирован
                            </span>
                        )}

                        {showNotification && !tokenExists && (
                            <span className='big p-3 bg-yellow-100 text-yellow-700 rounded-md'>
                    ...
                    <form onSubmit={handleAdminLogin} className="flex flex-col gap-4 w-full mt-4">
                        ...
                        <Button type="submit" className="blue w-full">Войти</Button>
                    </form>
                ) : (
                    ...
                    <>
                        {!tokenExists && showNotification && (
                            <>
                                ...
                                {saveSuccess && (
                                    <div className='mt-6 p-3 bg-green-100 text-green-700 text-center rounded-md'>
