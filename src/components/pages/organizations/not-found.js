...
export default function OrganNotFound() {
    return (
        <>
            <Header>
                <Header.Heading>Организации <span className='text-(--color-gray-black)'>/</span> Организация не найдена</Header.Heading>
            ...
            <div className="hero" style={{ placeItems: 'center' }}>
                <div className="flex flex-col gap-[1rem] col-start-4 col-end-10">
                    ...
                    <Button big onClick={() => router.push('/organizations')}>Вернуться назад</Button>
                </div>
            </div>
        </>
    );
