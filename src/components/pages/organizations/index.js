                        ...
                        <div className="flex flex-col gap-[.5rem]">
                            <div className="w-full flex items-center gap-[1.25rem]">
                                ...
                                <div className="w-full flex items-center gap-[.625rem]">
                                    <div className="w-full h-[1.375rem] rounded-[.5rem] bg-(--color-blue-noise)">
                                        <div className="h-[1.375rem] rounded-[.5rem] bg-(--color-blue)"
                                            style={{ width: `${(organ.indexes.znaniya / 5) * 100}%` }}
                                        ></div>
                                    </div>
                            ...
                            <div className="w-full flex items-center gap-[1.25rem]">
                                ...
                                <div className="w-full flex items-center gap-[.625rem]">
                                    <div className="w-full h-[1.375rem] rounded-[.5rem] bg-(--color-gray-plus-50)">
                                        <div className="h-[1.375rem] rounded-[.5rem] bg-(--color-gray-plus)"
                                            style={{ width: `${(organ.indexes.vzaim / 5) * 100}%` }}
                                        ></div>
                                    </div>
                                    <div className="flex items-center justify-center link
                                        w-[5rem] px-[.875rem] py-[.5rem] rounded-[.625rem]
                            ...
                            <div className="w-full flex items-center gap-[1.25rem]">
                                ...
                                <div className="w-full flex items-center gap-[.625rem]">
                                    <div className="w-full h-[1.375rem] rounded-[.5rem] bg-(--color-gray-plus-50)">
                                        <div className="h-[1.375rem] rounded-[.5rem] bg-(--color-gray-plus)"
                                            style={{ width: `${(organ.indexes.sreda / 5) * 100}%` }}
                                        ></div>
                                    </div>
                                    <div className="flex items-center justify-center link
                                        w-[5rem] px-[.875rem] py-[.5rem] rounded-[.625rem]
                            ...
                            <div className="w-full flex items-center gap-[1.25rem]">
                                ...
                                <div className="w-full flex items-center gap-[.625rem]">
                                    <div className="w-full h-[1.375rem] rounded-[.5rem] bg-(--color-gray-plus-50)">
                                        <div className="h-[1.375rem] rounded-[.5rem] bg-(--color-gray-plus)"
                                            style={{ width: `${(organ.indexes.zashita / 5) * 100}%` }}
                                        ></div>
                                    </div>
                                    <div className="flex items-center justify-center link
                                        w-[5rem] px-[.875rem] py-[.5rem] rounded-[.625rem]
                            ...
                            <div className="w-full flex items-center gap-[1.25rem]">
                                ...
                                <div className="w-full flex items-center gap-[.625rem]">
                                    <div className="w-full h-[1.375rem] rounded-[.5rem] bg-(--color-gray-plus-50)">
                                        <div className="h-[1.375rem] rounded-[.5rem] bg-(--color-gray-plus)"
                                            style={{ width: `${(organ.indexes.dannie / 5) * 100}%` }}
                                        ></div>
                                    </div>
                                    <div className="flex items-center justify-center link
                                        w-[5rem] px-[.875rem] py-[.5rem] rounded-[.625rem]
                            ...
                            <div className="w-full flex items-center gap-[1.25rem]">
                                ...
                                <div className="w-full flex items-center gap-[.625rem]">
                                    <div className="w-full h-[1.375rem] rounded-[.5rem] bg-(--color-gray-plus-50)">
                                        <div className="h-[1.375rem] rounded-[.5rem] bg-(--color-gray-plus)"
                                            style={{ width: `${(organ.indexes.auto / 5) * 100}%` }}
                                        ></div>
                                    </div>
                                    <div className="flex items-center justify-center link
                                        w-[5rem] px-[.875rem] py-[.5rem] rounded-[.625rem]
